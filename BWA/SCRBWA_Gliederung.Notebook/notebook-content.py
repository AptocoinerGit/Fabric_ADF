...
if response.status_code == 200:
    ...
    spark.sql("DROP TABLE IF EXISTS SCRBWA_Gliederung")

    # ✅ Step 7: Save to Lakehouse
    spark.createDataFrame(df).write.mode("overwrite").saveAsTable("SCRBWA_Gliederung")

    print("✅ Data successfully written to Lakehouse table 'SCRBWA_Gliederung'")
