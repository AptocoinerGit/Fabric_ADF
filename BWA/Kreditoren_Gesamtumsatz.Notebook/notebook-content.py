...
if response.status_code == 200:
    ...
    spark.sql("DROP TABLE IF EXISTS Kreditoren_Gesamtumsatz")

    # ✅ Step 7: Save to Lakehouse
    spark.createDataFrame(df).write.mode("overwrite").saveAsTable("Kreditoren_Gesamtumsatz")

    print("✅ Data successfully written to Lakehouse table 'Kreditoren_Gesamtumsatz'")
